    ...
    return (
        <div ref={containerRef} className={`${className} absolute`}>
            <svg viewBox="0 0 81.2 81.3">
                ...
                <path d="M26.9,2.4c22.4-7.9,45,4.4,51.9,24.1c7.6,21.8-2.9,45.4-25.3,52.7 c-19.9,6.5-42.6-2.6-50.8-23.7C-4.8,35.9,3.4,10.7,26.9,2.4 M34.7,10.4C15.7,14.3,6.5,32.8,10.6,48c4.3,16.2,20.1,26.1,35.5,23 c17-3.3,28.2-19.7,24.8-36.4C67.8,19.3,52.8,6.7,3.7,10.4" className={fillClass} mask={`url(#${maskId})`} />
            </svg>
        </div>
    );
};
