        ...
        <section className="relative bg-neutral-100 pt-20 2xl:pt-24 pb-52">
            ...
            <div className="relative container max-w-medium">
                ...
                <div className="relative mt-14 bg-white 2xl:-mx-20">
                    <div dangerouslySetInnerHTML={{ __html: text }} className="pt-8 xl:pt-12 pb-10 2xl:py-14 px-6 xl:px-10 max-w-5xl mx-auto max-h-[400px] overflow-hidden" />
                    ...
                    <Link href={route('Regulamento.index')} className="relative flex w-fit mx-auto gap-2 text-primary lg:text-sm xl:text-base 2xl:text-lg tracking-tight bg-secondary border-2 border-secondary fill-primary rounded-full px-4 xl:px-10 py-3.5 font-semibold transition-all hover:bg-primary hover:border-primary hover:text-secondary hover:fill-secondary translate-y-1/2">
