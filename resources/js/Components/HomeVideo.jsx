                ...
                <div className="grid grid-cols-2 gap-32">
                    ...
                    <Reveal direction="right" className="flex flex-col items-start h-full">
                        <div className="flex items-center my-6">
                            ...
                            <h4 className="font-tertiary text-3xl 2xl:text-[32px] font-bold uppercase">
                                A Copa começa em casa
                            </h4>
                        </div>

                        <h1 className="font-secondary text-6xl xl:text-7xl 2xl:text-[90px] 2xl:leading-[1.1] text-primary font-semibold uppercase tracking-tight mb-14">O seu lugar pra<br /> <span className="text-white">viver a emoção</span></h1>

                        <div className="text-xl max-w-xl mb-10">
                        ...
                        <CustomLink
                            ...
                            className="flex gap-2 max-lg:block text-primary lg:text-sm xl:text-base 2xl:text-lg tracking-tight bg-white border-2 border-primary fill-primary rounded-full px-4 xl:px-10 py-3.5 font-semibold transition-all hover:bg-primary hover:border-primary hover:text-secondary hover:fill-secondary mt-auto mb-24"
                        >
