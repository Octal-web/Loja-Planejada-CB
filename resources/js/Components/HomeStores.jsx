    ...
    return (
        <section className="relative bg-primary py-24 2xl:py-32">
            <div className="absolute right-0 top-0 max-md:scale-50 max-2xl:scale-75 origin-top-right">
                ...
                <ShortArrowPath className="-top-4 -right-4 translate-x-1/2 rotate-[160deg] w-[417px]" fillClass="fill-secondary" delay={1} />
            </div>

            <div className="container max-w-medium">
                <div className="flex flex-col items-center justify-center mb-7 2xl:mb-10">
                    <h4 className="font-tertiary text-white text-xl sm:text-2xl lg:text-3xl 2xl:text-[32px] font-bold uppercase mb-4 sm:mb-6">
                        Onde comprar
                    </h4>
                ...
                <p className="text-white sm:text-lg lg:text-xl 2xl:text-[22px] text-center leading-tight tracking-tight max-w-[580px] mx-auto">Encontre a loja Casa Brasileira mais próxima de você e fale com um de nossos especialistas.</p>
                ...
                <CustomLink
                    ...
                    className="relative flex gap-2 text-white lg:text-sm xl:text-base 2xl:text-lg tracking-tight border-2 border-white fill-white rounded-full px-4 xl:px-10 py-3.5 font-semibold transition-all hover:bg-secondary hover:border-secondary hover:text-primary hover:fill-primary mt-20 mx-auto w-fit z-[1]"
                >
            ...
            <div className="absolute left-0 bottom-0 max-md:scale-50 max-2xl:scale-75 origin-bottom-left">
                <MarkPath className="bottom-28 left-[25em] w-[81px]" fillClass="fill-secondary" />
                <ShortArrowPath className="bottom-52 -left-30 rotate-[18deg] w-[417px]" fillClass="fill-secondary" />
            </div>
        </section>
    );
};
