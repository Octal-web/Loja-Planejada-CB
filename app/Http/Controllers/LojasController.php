            ...
            $lojas = Loja::query()
                ...
                ->map(function($loja) {
                    ...
                    return [
                        ...
                        'whatsapp' => $this->formatTelefone($loja->whatsapp)
                    ];
                });
